...
<body>
    ...
    ================================================== -->
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<jtsl:forEach items="${ banners }" var="banner" varStatus="loop">
			    <jtsl:choose>
			    	<jtsl:when test="${ loop.index == '0' }">
		...
		<div class="row page-header">
			<div class="col-lg-12">
				...
				<form class="form-inline" action="${urlRoot }buscarFecha"
					method="post">
					<div class="form-group">
						<label for="fecha">Fecha: </label> <select id="fecha" name="fecha"
							class="form-control">
							<jtsl:forEach items="${fechas}" var="fecha">
								<jtsl:choose>
									<jtsl:when test="${fechaBusqueda eq fecha}">
				...
				<jtsl:forEach items="${ peliculas}" var="pelicula">
					<div class="col-xs-12 col-sm-6 col-md-3">
						<img class="img-rounded"
							src="${urlPublic }/images/${pelicula.pImage }"
							alt="Generic placeholder image" width="150" height="200">
						<h4>${pelicula.pTitulo }</h4>
						<h4>
							<span class="label label-default">${pelicula.pClasificacion }</span>
							<span class="label label-default">${pelicula.pDuracion }</span> <span
								class="label label-default">${pelicula.pGenero }</span>
						</h4>
						<p>
							<!--@PathVariable-->
							<a class="btn btn-sm btn-primary"
								href="detalle/${pelicula.pId}/${fechaBusqueda }" role="button">Consulta
								Horarios &raquo;</a>
							<!-- RequestParam
								<a class="btn btn-sm btn-primary" href="detail?idPelicula=${pelicula.pId}&fecha=${fechaBusqueda }" role="button">Consulta
								Horarios &raquo;</a> -->
						</p>
					</div>
