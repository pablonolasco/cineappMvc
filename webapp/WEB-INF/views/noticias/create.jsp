...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<spring:url value="/noticias/save-noticia" var="urlForm"></spring:url>
		<form action="${ urlForm }" method="post">
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						<label for="titulo">Titulo</label> <input type="text"
							class="form-control" name="nTitulo" id="titulo"
							required="required" />
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label for="estatus">Estatus</label> <select id="estatus"
							name="nEstatus" class="form-control">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						...
						<textarea class="form-control" name="nDetalle" id="detalle"
							rows="10"></textarea>
					</div>
				</div>
			</div>
